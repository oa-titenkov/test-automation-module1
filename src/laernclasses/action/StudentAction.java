...
public class StudentAction {
  ...
  public static void main(String[] args) {
    ...
    studentList.add(new Student(0, "Oleg", "Titenkov", "FIS", "31.07.1993", 1, "PS22"));
    studentList.add(new Student(1, "Andrei", "Popel", "FAIS", "17.08.1992", 1,"PS22"));
    studentList.add(new Student(2, "Olga", "Makarenko", "FAIS", "17.08.1992",2, "PS22" ));
    studentList.add(new Student(3, "Aleksei", "Loboiko", "FAIS","17.08.1992",2,"PS21" ));
    studentList.add(new Student(4, "Anton", "Savchkov", "FIS", "17.08.1992", 2,"PS21"));
