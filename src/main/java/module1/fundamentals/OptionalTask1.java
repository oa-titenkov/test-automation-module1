...
public class OptionalTask1 {
  ...
  public static void main(String[] args) {
    ...
    printSortedNumbers(numberArray);
    printMoreAndLessThanAverageNumbers(numberArray);
    printMinDifferentDigitsNumber(numberArray);
    printEvenDigitsThenEqualOddEvenDigits(numberArray);
    printAscendingNumber(numberArray);
    printDifferentDigitsNumber(numberArray);
  }

  private static void printMaxAndMinNumber(String[] numberArray) {
  ...
  private static void printSortedNumbers(String[] numberArray) {
  ...
  private static void printMoreAndLessThanAverageNumbers(String[] numberArray) {
  ...
  private static void printEvenDigitsThenEqualOddEvenDigits(String[] numberArray) {
    int evenCount = 0;
    int evenOddCount = 0;
    for(String item : numberArray) {
      int even = 0;
  ...
  private static void printAscendingNumber(String[] numberArray) {
